...
export const createSquareBoardWithBonus = (size: number): Square[][] => {
  ...
  // Define the coordinates for each bonus type (only top-left quadrant / first quadrant)
  ...
  const DL: [number, number][] = [
    [0,6],[0,8],[2,2],[2,12],[3,3],[3,11],[4,0],[4,7],[4,14],
    [6,0],[6,6],[6,8],[6,14],[7,4],[7,10],[8,0],[8,6],[8,8],[8,14],
    [10,3],[10,11],[11,2],[11,12],[12,2],[12,12],[14,6],[14,8]
  ];
